...
| --- | ---: |
| Timing | WNS 1.504 ns, TNS 0, WHS 0.029 ns |
| `CLK_ADC` | 62.5 MHz |
| `CLK_CNN` | 170.010 MHz |
| LUT | 29,105 |
| FF | 15,924 |
...
| DSP | 77 |
| IOB | 0 |
| SAIF power | 1.414 W total, High confidence |
| SAIF net match | 98% |
...
not optimized away in the current implementation.
...
in xsim; the fallback logged 162,803 objects and produced a 98% SAIF net match.
On the reference Ubuntu run, the full-DUT object enumeration took about 100
minutes while the simulation itself completed in under one minute. The detailed
xsim trace is kept in `build/vivado_post_impl_saif/xsim/xsim.log`.
