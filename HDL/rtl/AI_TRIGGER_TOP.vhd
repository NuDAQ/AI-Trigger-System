...
--   exceeds CNN_THRESH.  WRAPPER_TOP returns ap_fixed<22,11> byte-aligned into
--   the low 22 bits of a 32-bit TDATA word, matching its reference testbench:
--   float_score = signed(score[21:0]) / 2048.
--
-- CNN_THRESH encoding (ap_fixed<22,11>, raw / 2048 = float score):
--   0.5 -> 22'sd1024    1.0 -> 22'sd2048    -6.0 -> 22'sd-12288
-- =============================================================================
