...
-- control live in CLK_ADC.  Two CNN lanes are shared by continuous AI and
-- Hi-Lo-gated AI work; no trigger mode duplicates a CNN or waveform store.
-- CNN scores retain the wrapper's signed ap_fixed<21,12> payload in bits 20:0.
-- Threshold snapshots retain the complete signed external word (unit 1/16).
-- CNN_RESULT_ARBITER compares them through the system-owned numeric adapter.
-- =============================================================================
