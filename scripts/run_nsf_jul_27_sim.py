...
def build_report(
    ...
    for manifest_row in manifest:
        ...
        trigger_decision = int(score_raw21 / 512.0 > cnn_thresh_raw / 16.0)
        ...
        for batch_index, input_batch in enumerate(input_batches):
            ...
            row: dict[str, object] = {
                ...
                "cnn_threshold_float": f"{cnn_thresh_raw / 16.0:.6f}",
...
def main() -> None:
    ...
    expected_threshold_raw = args.score_threshold * 16.0
