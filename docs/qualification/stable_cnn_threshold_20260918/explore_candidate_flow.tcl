...
if {$::RUN_BUILD_IMPL} {
    ...
    # Address any remaining violations after routing. Positive-slack margin is
    # pursued by Explore placement/routing above; phys_opt may skip it.
    # No retiming is requested; RTL transaction latency remains unchanged.
